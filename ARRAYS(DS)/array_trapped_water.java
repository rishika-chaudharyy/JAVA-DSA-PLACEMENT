//Write a program to calculate the trapped water between the blocks
//left max boundary and right max boundary
//min of both will be the water level
//subtract the height of the block and multiply the width and repeat the process by adding
